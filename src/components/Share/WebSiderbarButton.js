...
const WebSidebarButton = ({ toggleSidebar, className, isSidebarOpen }) => {
  ...
  useEffect(() => {
    ...
    // Clean up the tooltip when the component unmounts or tooltipText changes
    return () => {
      if (instance) {
        instance.destroy();
      }
...
export default WebSidebarButton;
